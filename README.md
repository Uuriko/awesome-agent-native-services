...
| [XiuRouter](services/llm-gateway-and-routing/xiurouter.md) | Claude, GPT, Gemini, and more through one API | Protocol-aware setup · Scoped API key · Request usage records · Four native routes | ⚠️ | Create a scoped key, 
| [Dasha Compute](services/llm-gateway-and-routing/dasha-compute.md) | OpenAI-compatible inference marketplace on idle community hardwthen follow [Agent integrations](https://router.xiu.ai/en/integrations) for the client's native protocol |
